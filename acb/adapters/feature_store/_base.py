...
class FeatureIngestionRequest(BaseModel):
    ...
    mode: str = Field(
        default="append",
        description="Ingestion mode (append, overwrite)",
    )
    metadata: dict[str, Any] = Field(
        default_factory=dict,
...
class FeatureIngestionResponse(BaseModel):
    ...
    latency_ms: float | None = Field(
        default=None,
        description="Ingestion latency in ms",
    )
...
class FeatureMonitoring(BaseModel):
    ...
    last_updated: datetime | None = Field(
        default=None,
        description="Last monitoring update",
    )
    metadata: dict[str, Any] = Field(
        default_factory=dict,
...
class FeatureLineage(BaseModel):
    ...
    data_sources: list[str] = Field(
        default_factory=list,
        description="Source data tables",
    )
...
class FeatureStoreSettings(BaseModel):
    ...
    offline_store_host: str | None = Field(
        default=None,
        description="Offline store host",
    )
