...
class MockServiceProvider:
    ...
    def create_performance_service_mock(
        ...
        async def mock_benchmark(operation: str, iterations: int = 10):
            import asyncio
            import random
    ...
    def create_validation_service_mock(
        ...
        async def mock_sanitize(data: str):
    ...
    def create_repository_service_mock(
        ...
        async def mock_get_repository(entity_type: str):
            ...
            if entity_type not in repo_mock._repositories:
                ...
                async def repo_find(entity_id: int):
                    return mock_repo._entities.get(entity_id)

                async def repo_save(entity: dict):
                    if "id" not in entity:
                ...
                async def repo_delete(entity_id: int):
