...
async def main():
    ...
    try:
        ...
        print("1. Start the MCP server: uvicorn examples.mcp_demo:app --host 0.0.0.0 --port 8000")
        print("2. Run this client script to interact with the server")
        
    except ImportError as e:
        print(f"Failed to import required modules: {e}")
        print("Install dependencies with: pip install httpx")
        return 1
